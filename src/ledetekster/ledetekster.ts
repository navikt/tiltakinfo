...
export default {
    ...
    'informasjon-header': 'Trenger du hjelp for å komme i jobb?',
    'informasjon-ingress': 'Av og til kan man trenge litt ekstra for å komme i jobb. Snakk med oss, så kan vi sammen finne ut hva som passer for deg.',
