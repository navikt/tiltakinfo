...
export default {
    'startside-brodsmuler-dittnav': 'Ditt NAV',
    'startside-brodsmuler-dittsykefravaer': 'Ditt sykefravær',
    'startside-brodsmuler-tiltak': 'Tiltak',
    'startside-fleretiltak-header': 'Vi har flere tiltak',
    'startside-fleretiltak-lenke': 'Se oversikt over tiltakene.',
    'startside-fleretiltak-passedeg': 'NAV har også andre tiltak som kan hjelpe deg ut i jobb.',
    'startside-informasjon-header': 'Trenger du hjelp for å komme i jobb?',
